    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmPauseScreen.innerHTML = "<div style='padding:10px;'>Pause<p/>Je comprends que tu mette en pause</div>";
        ...
        function createWelcomeElement() {
            ...
            if (config.fullScreen) {
                fullScreenText = "J'pense que tu vas douiller :).";   
            }
            welcomeTxt.innerHTML = "Snake<p></p>Bravo t'as découvert le mode caché." + fullScreenText + "<p></p>";
