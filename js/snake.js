...
SNAKE.Snake = SNAKE.Snake || (function() {
    ...
    */
    ...
    document.getElementById(mode).addEventListener('click', function () { snakeSpeed = speed; });
            ...
            getMode('Easy', snakeSpeed = 100);
            getMode('Medium', snakeSpeed = 75);
            getMode('Difficult', snakeSpeed = 50);
			getMode('Hardcore', snakeSpeed = 25);
        // ----- public variables -----
        me.snakeBody = {};
        ...
        me.handleDeath = function() {
            function recordScore () {
                ...
                if (me.snakeLength > highScore) {
                    alert('Bravo t es vraiment un nolife, t as fait' + highScore + '.');
    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmPauseScreen.innerHTML = "<div style='padding:10px;'>Pause<p/>Alors ca devient chaud?</div>";
            
            elmAboutPanel = document.createElement("div");
            elmAboutPanel.className = "snake-panel-component";
            elmAboutPanel.innerHTML = "<a href='jean/index.html' class='snake-link' style='opacity:1;'>Snake. Pas fait par Thomas.</a>  <a href='https://github.com/patorjk/JavaScript-Snake' class='snake-link' style='opacity:0;'>1</a>";
            
            elmLengthPanel = document.createElement("div");
            elmLengthPanel.className = "snake-panel-component";
            elmLengthPanel.innerHTML = "<a class='snakelength'>Allez gros</a>";
        ...
        function createWelcomeElement() {
            ...
            if (config.fullScreen) {
                fullScreenText = "Appuie sur F11 pour jouer en plein ecran.";   
            }
            welcomeTxt.innerHTML = "Snake<p></p>Jean a ete elu delegue on peut mourir tranquille. " + fullScreenText + "<p></p>";
            var welcomeStart = document.createElement("button");
            welcomeStart.appendChild(document.createTextNode("Jouer"));
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "Snake<p></p>T'es mort.<p></p>";
            var tryAgainStart = document.createElement("button");
            tryAgainStart.appendChild( document.createTextNode("Reessaye un coup"));
        ...
        */   
        me.resetBoard = function() {
            ...
            mySnake.reset();
            elmLengthPanel.innerHTML = "T'es nul";
